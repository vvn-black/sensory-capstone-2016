...
namespace UnityStandardAssets.Characters.FirstPerson
{
    ...
    public class RigidbodyFirstPersonController : MonoBehaviour{
        ...
        public class MovementSettings {
            ...
            public void UpdateDesiredTargetSpeed(Vector2 input) {
				...
				if (input.y > 0) //forwards
					CurrentTargetSpeed = ForwardSpeed; //handled last, as if strafing and moving forward at the same time, forward speed should take precedence
        ...
        public Camera cam;
        public StartingLocation startingLocation = new StartingLocation();
